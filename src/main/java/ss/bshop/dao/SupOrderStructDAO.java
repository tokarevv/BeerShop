...
public class SupOrderStructDAO implements ISupOrderStructDAO {
	...
	public SupOrderStructure get(Long id) {
		return (SupOrderStructure) sessionFactory.getCurrentSession().get(SupOrderStructure.class, id);
	}

	@SuppressWarnings("unchecked")
	@Override
	public List<SupOrderStructure> getAll() {
		return sessionFactory.getCurrentSession().createQuery("from SupOrderStructure")
				.list();
	}

	@Override
	public void remove(Long id) {
		SupOrderStructure structure = (SupOrderStructure) sessionFactory.getCurrentSession().load(
