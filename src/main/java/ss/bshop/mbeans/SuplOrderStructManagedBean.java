...
@SessionScoped
public class SuplOrderStructManagedBean implements Serializable {
    ...
    SuplOrderManagedBean orderBean;
    
   	public SuplOrderManagedBean getOrderBean() {
		return orderBean;
	}

	public void setOrderBean(SuplOrderManagedBean orderBean) {
